...
## Root folder rules
Only these belong at root: `Cargo.toml`, `Cargo.lock`, `rust-toolchain.toml`, `cliff.toml`, `release.toml`, `CHANGELOG.md`, `LICENSE`, `src/`, `tests/`, `benches/`, `.gitignore`, `CLAUDE.md`, `.claude/`, `README.md`, `frontend/`, `docs/`, `.github/`, `Dockerfile`, `.dockerignore`, `railway.toml`
