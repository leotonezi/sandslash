...
mod tests {
    ...
    fn title_too_long() {
        ...
        let f = audit(
            &format!("<html><head><title>{long}</title></head></html>"),
            "https://example.com/",
        );
    ...
    fn title_ok() {
        let f = audit(
            "<html><head><title>This Title Is Exactly Right Length</title></head></html>",
            "https://example.com/",
        );
    ...
    fn description_long() {
        ...
        let f = audit(
            &format!(r#"<html><head><meta name="description" content="{long}"></head></html>"#),
            "https://example.com/",
        );
