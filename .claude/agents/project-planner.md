...
## Project reference
- Full spec: PLAN.md
- Detailed implementation steps: IMPLEMENTATION.md (phases 0–4, ~35 sessions)
...
1. Understand which IMPLEMENTATION.md step is being worked on
...
4. Flag gotchas from IMPLEMENTATION.md that apply to this step
5. Break the step into smaller subtasks if it's still too large
6. Define concrete done-criteria

## Output format
- **Step**: which IMPLEMENTATION.md step (e.g. "3.6 Worker pool engine")
- **Goal**: one sentence
...
- **Gotchas**: relevant warnings from IMPLEMENTATION.md
